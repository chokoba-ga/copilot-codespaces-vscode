...
import { DaySelector, guessCurrentDayId, EmptyState } from '@/components/common';
...
export function RegisterPage() {
  ...
  useEffect(() => {
    if (event && !dayId) setDayId(guessCurrentDayId(event.days));
  }, [event, dayId]);
    ...
    <div className="flex h-full flex-col">
      <div className="px-4 pt-3">
        <div className="flex items-center justify-between gap-2">
          <DaySelector days={event.days} value={dayId} onChange={setDayId} />
