        ...
        <Card key={e.id} className="p-3.5">
          <div className="flex items-start justify-between gap-2">
            <div className="min-w-0">
              ...
              <p className="truncate text-[14px] font-bold text-neutral-800 dark:text-neutral-100">{e.description}</p>
            ...
            <span className="flex-shrink-0 text-lg font-black text-neutral-900 dark:text-neutral-50">-{formatYen(e.amount)}</span>
          </div>
